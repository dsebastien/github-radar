...
- **Noise controls**: "Hide bots" drops items opened by Dependabot, Renovate, GitHub Actions and other apps. "Mute this repository" (in any repository's ⧉ menu) hides a repository's items everywhere; the sources panel lists muted repositories with their item counts to unmute them. "Hide archived" and "Hide dormant repos" drop items of archived repositories and of repositories nothing was pushed to for 90+ days; such repositories carry an "archived" or "dormant" tag on cards, group headers and the Repos filter. Stats, facets and source counts follow every rule.
